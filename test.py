...
class ItemTest(unittest.TestCase):
    def setUp(self):
        self.item=Item(5,'coke',1.99)

    def test_itemString(self):
        self.assertEqual(str(self.item),self.item.itemname)

    def test_getPrice(self):
        self.assertEqual(str(self.item.getItemPrice()), '1.99')

    def test_getItemNumber(self):
        self.assertEqual(str(self.item.getItemNumber()),'5')

class InventoryTest(unittest.TestCase):
    def setUp(self):
        self.item1=Item(1,'coke', 1.99)
        self.item2=Item(2,'water', 0.99)
        self.item3=Item(3,'orange', 1.49)
...
class OrderTest(unittest.TestCase):
   ...
   def test_CalculateTotal(self):
        ...
        self.assertEqual(str(payment), 'Your payment today will be 7.94')
